...
var onRequestPost = /* @__PURE__ */ __name(async (context2) => {
  ...
  try {
    ...
    if (env2.AI && typeof env2.AI.run === "function") {
      const input = {
        audio: [...audioBytes]
      };
      const response = await env2.AI.run("@cf/openai/whisper", input);
...
// ../.wrangler/tmp/pages-fD2bno/functionsRoutes-0.3139058382524692.mjs
var routes = [
  {
